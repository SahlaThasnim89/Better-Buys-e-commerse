                ...
                (function() {
                    ...
                    function G(a, b) {
                        var c = Cb(a),
                            ...
                            j = i.length;
                        for (var k in a) !b && !db.call(a, k) || h && ("length" == k || f && ("offset" == k || "parent" == k) || g && ("buffer" == k || "byteLength" == k || "byteOffset" == k) || ca(k, j)) || i.push(k);
                        return i
                    }
                    ...
                    function R(a, b, c, d, e, f, g) {
                        ...
                        if (l) {
                            var m = Cb(i),
                                n = !m && Db(i),
                                o = !m && !n && Eb(i);
                            k = i, m || n || o ? Cb(h) ? k = h : pa(h) ? k = W(h) : n ? (l = !1, k = T(i, !0)) : o ? (l = !1, k = V(i, !0)) : k = [] : ua(i) || Bb(i) ? (k = h, Bb(h) ? k = va(h) : sa(h) && !qa(h) || (k = ba(i))) : l = !1
                        }
                    ...
                    function Y(a) {
                        return S(function(b, c) {
                            var d = -1,
                                ...
                                f = e > 1 ? c[e - 1] : void 0,
                                g = e > 2 ? c[2] : void 0;
                            for (f = a.length > 3 && "function" == typeof f ? (e--, f) : void 0, g && da(c[0], c[1], g) && (f = e < 3 ? void 0 : f, e = 1), b = Object(b); ++d < e;) {
                                var h = c[d];
                                h && a(b, h, d, f)
                            }
                            return b
                    ...
                    function ja(a, b, c) {
                        return b = tb(void 0 === b ? a.length - 1 : b, 0),
                            function() {
                                for (var e = arguments, f = -1, g = tb(e.length - b, 0), h = Array(g); ++f < g;) h[f] = e[b + f];
                                f = -1;
                    ...
                    i.prototype.clear = j, i.prototype.delete = k, i.prototype.get = l, i.prototype.has = m, i.prototype.set = n, o.prototype.clear = p, o.prototype.delete = q, o.prototype.get = r, o.prototype.has = s, o.prototype.set = t, u.prototype.clear = v, u.prototype.delete = w, u.prototype.get = x, u.prototype.has = y, u.prototype.set = z, A.prototype.clear = B, A.prototype.delete = C, A.prototype.get = D, A.prototype.has = E, A.prototype.set = F;
                    var yb = Z(),
                        zb = rb ? function(a, b) {
            ...
            ! function(b, e) {
                ...
                return function() {
                    ...
                    var b = {
                            720: function(a, b, c) {
                                function d(a, b, c, d, e, f) {
                                    ...
                                    return l = 1 - (n = 3 * b) - (m = 3 * (d - b) - n), i = 1 - (k = 3 * c) - (j = 3 * (e - c) - k), g = a, h = function(a) {
                                            return 1 / (200 * a)
                                        }(f),
                                        function(a) {
                                            return ((i * a + j) * a + k) * a
                                ...
                                function o(a) {
                                    ...
                                    [b, a._originalState, a._targetState].forEach(Ya), a._tokenData = function(a) {
                                        var b, c, d = {};
                                        for (var e in a) {
                                            var f = a[e];
                                            "string" == typeof f && (d[e] = {
                                                formatString: (b = f, c = void 0, c = b.match(Pa), c ? (1 === c.length || b.charAt(0).match(Oa)) && c.unshift("") : c = ["", ""], c.join(Ua)),
                                                chunkNames: Va($a(f), e)
                                            })
                                        }
                                        return d
                                ...
                                var A, B, C, D, E = function(a) {
                                    ...
                                    ma = function(a, b, c, d, e) {
                                        var f = la(b, c, d, e);
                                        return f.displayName = a, f.x1 = b, f.y1 = c, f.x2 = d, f.y2 = e, La.formulas[a] = f
                                    },
                                    na = function(a) {
                                    ...
                                    ua = "function",
                                    va = "string",
                                    wa = pa.requestAnimationFrame || pa.webkitRequestAnimationFrame || pa.oRequestAnimationFrame || pa.msRequestAnimationFrame || pa.mozCancelRequestAnimationFrame && pa.mozRequestAnimationFrame || setTimeout,
                                    xa = function() {},
                                    ya = null,
                                    za = null,
                                    Aa = k({}, y),
                                    Ba = function(a, b, c, d, e, f, g) {
                                        var h, i, j, k = a < f ? 0 : (a - f) / e,
                                            l = !1;
                                        for (var m in g && g.call && (l = !0, h = g(k)), b) l || (h = ((i = g[m]).call ? i : Aa[i])(k)), j = c[m], b[m] = j + (d[m] - j) * h;
                                        return b
                                    },
                                    Ca = function(a, b) {
                                        var c = a._timestamp,
                                        ...
                                        if (!(b < c + e)) {
                                            ...
                                            k && a._applyFilter(sa), i < c + e ? c = f = i = 1 : c += e, Ba(i, d, a._originalState, g, f, c, a._easing), k && a._applyFilter(qa), a._render(d, a._data, j)
                                        }
                                    },
                                    Da = function() {
                                    ...
                                    Ia = function(a) {
                                        ...
                                        if (Aa[b]) return Aa[b];
                                        if (d === va || d === ua)
                                            for (var e in a) c[e] = b;
                                        else
                                            for (var f in a) c[f] = b[f] || oa;
                                        return c
                                    },
                                    Ja = function(a) {
                                        a === ya ? (ya = a._next) ? ya._previous = null : za = null : a === za ? (za = a._previous) ? za._next = null : ya = null : (C = a._previous, D = a._next, C._next = D, D._previous = C), a._previous = a._next = null
                                    },
                                ...
                                var La = function() {
                                    ...
                                    return b = a, c = [{
                                        ...
                                        value: function() {
                                            ...
                                            return this._isPlaying && this.stop(), !b && this._config || this.setConfig(b), this._pausedAtTime = null, this._timestamp = a.now(), this._start(this.get(), this._data), this._delay && this._render(this._currentState, this._data, 0), this._resume(this._timestamp)
                                        }
                                    }, {
                                        key: "setConfig",
                                        value: function() {
                                            ...
                                            var e = c.promise,
                                                ...
                                                m = c.step,
                                                n = void 0 === m ? xa : m;
                                            this._data = c.data || c.attachment || this._data, this._isPlaying = !1, this._pausedAtTime = null, this._scheduleId = null, this._delay = b.delay || 0, this._start = i, this._render = l || n, this._duration = c.duration || 500, this._promiseCtor = f, j && (this._resolve = j);
                                            var o = b.from,
                                                p = b.to,
                                                q = void 0 === p ? {} : p,
                                            ...
                                            for (var w in r) {
                                                var x = r[w];
                                                v || g(x) !== va || (v = !0), s[w] = x, t[w] = q.hasOwnProperty(w) ? q[w] : x
                                            }
                                            if (this._easing = Ia(this._currentState, c.easing, this._easing), this._filters.length = 0, v) {
                                                for (var y in a.filters) a.filters[y].doesApply(this) && this._filters.push(a.filters[y]);
                                        ...
                                        key: "pause",
                                        value: function() {
                                            if (this._isPlaying) return this._pausedAtTime = a.now(), this._isPlaying = !1, Ja(this), this
                                        }
                                    }, {
                                        key: "resume",
                                        value: function() {
                                        ...
                                        value: function() {
                                            ...
                                            return null === this._timestamp ? this.tween() : this._isPlaying ? this._promise : (this._pausedAtTime && (this._timestamp += b - this._pausedAtTime, this._pausedAtTime = null), this._isPlaying = !0, null === ya ? (ya = this, za = this) : (this._previous = za, za._next = this, za = this), this)
                                        }
                                    }, {
                                        key: "seek",
                                        value: function(b) {
                                            b = Math.max(b, 0);
                                            var c = a.now();
                                            return this._timestamp + b === 0 || (this._timestamp = c - b, Ca(this, c)), this
                                        }
                                    }, {
                                        key: "stop",
                                        value: function() {
                                            ...
                                            return a && (b && this._applyFilter(sa), Ba(1, this._currentState, this._originalState, this._targetState, 1, 0, this._easing), b && (this._applyFilter(qa), this._applyFilter(ra))), this._resolve && this._resolve({
                                                data: this._data,
                                        ...
                                        value: function() {
                                            ...
                                            return this._isPlaying ? (this._reject && this._reject({
                                                ...
                                                state: b,
                                                tweenable: this
                                            }), this._resolve = null, this._reject = null, this.stop(a)) : this
                                        }
                                    }, {
                                        key: "isPlaying",
                                        value: function() {
                                ...
                                l(La, "now", function() {
                                    ...
                                    return wa = a
                                }), l(La, "filters", {}), l(La, "formulas", Aa), Ga(!0);
                                var Ma, Na, Oa = /(\d|-|\.)/,
                                    Pa = /([^\-0-9.]+)/g,
                                    Qa = /[0-9.-]+/g,
                                    Ra = (Ma = Qa.source, Na = /,\s*/.source, new RegExp("rgba?\\(".concat(Ma).concat(Na).concat(Ma).concat(Na).concat(Ma, "(").concat(Na).concat(Ma, ")?\\)"), "g")),
                                    Sa = /^.*\(/,
                                    Ta = /#([0-9]|[a-f]){3,6}/gi,
                                    Ua = "VAL",
                                    Va = function(a, b) {
                                    ...
                                    Wa = function(a) {
                                        return "rgb(".concat((b = a, 3 === (b = b.replace(/#/, "")).length && (b = (b = b.split(""))[0] + b[0] + b[1] + b[1] + b[2] + b[2]), [n(b.substr(0, 2)), n(b.substr(2, 2)), n(b.substr(4, 2))]).join(","), ")");
                                        var b
                                    },
                                    Xa = function(a, b, c) {
                                        var d = b.match(a),
                                    ...
                                    Za = function(a) {
                                        ...
                                        if (4 === b.length) return "".concat(d).concat(c.join(","), ",").concat(b[3], ")");
                                    ...
                                    fb = function(a, b, c, d) {
                                        var e = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0,
                                            f = s({}, a),
                                            g = Ia(a, d);
                                        for (var h in db._filters.length = 0, db.set({}), db._currentState = f, db._originalState = a, db._targetState = b, db._easing = g, eb) eb[h].doesApply(db) && db._filters.push(eb[h]);
                    ...
                    return a.d = function(b, c) {
                        for (var d in c) a.o(c, d) && !a.o(b, d) && Object.defineProperty(b, d, {
                            enumerable: !0,
                            get: c[d]
                        })
                    }, a.g = function() {
